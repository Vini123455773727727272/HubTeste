...
local Window = Libary:MakeWindow({
    Title = "Dev Hub | Brookhaven RP ",
    SubTitle = "by: Vinilatas and Lynix",
    LoadText = "Carregando Dev Hub",
    Flags = "DevHub_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://110941051056693", BackgroundTransparency = 0 },
...
InfoTab:AddParagraph({ "Owner / Developer:", "Vinilatas and Lynix." })
InfoTab:AddParagraph({ "Colaborações:", "deividTaxas100000" })
